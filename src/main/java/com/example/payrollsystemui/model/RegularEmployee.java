...
public class RegularEmployee extends Employee {
	public RegularEmployee(String employeeId, String fullName, String department, String positionTitle,
			...
			String status) {
		super(employeeId, fullName, department, positionTitle, EmploymentType.REGULAR, basicRate, workSchedule,
